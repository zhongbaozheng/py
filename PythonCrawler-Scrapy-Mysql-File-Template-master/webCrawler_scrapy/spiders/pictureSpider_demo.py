...
#导入item对应的类，crawlPictures是项目名，items是items.py文件，import的是items.py中的class，也可以import *
...
sche.add_job(process.crawl, "interval", args=[Spdier_pictures], seconds=300)   #定时任务，语法上这个可以改很多东西，包括中断这些
sche.start()
process.start(False)
